				...
				for(var property1 in output) {
					for(var property2 in output[property1].schedule) {
						var dateexcel = dateFormat(output[property1].schedule[property2].date, "yyyy-mm-dd");
							...
							string1 =   string1 + output[property1].firstname + " for "  +  output[property1].schedule[property2].starttime + " : " + output[property1].schedule[property2].endtime  + " @ " + output[property1].schedule[property2].location  +  ' ; ';
							}
					}	
